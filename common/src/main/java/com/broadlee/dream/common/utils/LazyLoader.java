...
import static com.broadlee.dream.common.utils.BasicConstant.EMPTY_STRING;
...
public abstract class LazyLoader<T, C> {
    ...
    protected LazyLoader(Loader<T, C> loader) {
        this.loader = Assert.notNull(loader);
    }
    ...
    public String toString() {
        return String.format("LazyLoader(%s%s)", Loader.class.getSimpleName(), testInstance() ? ", loaded" : EMPTY_STRING);
    }
}
