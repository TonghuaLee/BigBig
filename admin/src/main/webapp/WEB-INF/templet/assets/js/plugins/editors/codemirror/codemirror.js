...
(function(mod) {
  ...
  function CodeMirror(place, options) {
    ...
    if (options.lineWrapping)
      this.display.wrapper.className += " CodeMirror-wrapper";
  ...
  function Display(place, doc) {
    ...
    // our fake cursor out of view. On webkit, when wrapper=off, paste is
  ...
  function wrappingChanged(cm) {
    if (cm.options.lineWrapping) {
      addClass(cm.display.wrapper, "CodeMirror-wrapper");
      cm.display.sizer.style.minWidth = "";
    } else {
      rmClass(cm.display.wrapper, "CodeMirror-wrapper");
      findMaxLine(cm);
    }
  ...
  // Operations are used to wrapper a series of changes to the editor
  ...
  // 'wrapper f in an operation, performed on its `this` parameter'.
